    ...
    <ul className="blog-list">
      {data.blocks_layout.items.map((id) => {
        if (data.blocks[id]["@type"] === "slate") {
          ...
          const teaserLink = teaser.href && teaser.href.length > 0 ? teaser.href[0]["@id"] : null;
          const teaserLinkTitle = teaser.href && teaser.href.length > 0 ? teaser.href[0].title : null;
