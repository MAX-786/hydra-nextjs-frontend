        ...
        if (!throttleTimeout) {
          throttleTimeout = setTimeout(() => {
            ...
            if (closestBlock) {
              ...
              const prevHighlighted = insertAt === 0 ? document.querySelector(".highlighted-block") :  document.querySelector(".highlighted-block-bottom");

              if (prevHighlighted) {
                prevHighlighted.classList.remove("highlighted-block","highlighted-block-bottom");
              }
              ...
              closestBlock.classList.add(`${insertAt === 0 ? "highlighted-block" : "highlighted-block-bottom"}`);
      ...
      const onMouseUp = () => {
        ...
        if (closestBlockUid) {
          ...
          if (draggedBlockIndex !== -1 && targetBlockIndex !== -1) {
            ...
            if (insertAt === 0) {
              document.querySelector(".highlighted-block").classList.remove("highlighted-block");
            } else {
              document.querySelector(".highlighted-block-bottom").classList.remove("highlighted-block-bottom");
            }
            window.parent.postMessage(
